...
<div class="actions-form">
    ...
    <form action="" class="form-home text-center">
        <div class="form-group">
            <input type="text" name="cities_origin" list="cities_origin" class="form-control"
        ...
        <div class="form-group">
            <input type="text" name="cities_destination" list="cities_destination" class="form-control"
    ...
    <div class="container banner-ctc-background-over-white card">
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div>
                    <p>ASSINE E TENHA ACESSO A TODOS OS NOSOS CURSOS DISPONÍVEL NA ESPECIALIZATI ACADEMY. MAIS BARATO
                        QUE UM CAFÉ POR DIA!</p>
                </div>
            </div>
            <div class="col-md-2">
                <a href="https://academy.especializati.com.br" target="_blank"
